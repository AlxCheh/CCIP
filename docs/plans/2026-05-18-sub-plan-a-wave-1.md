...
**Spec source:** `docs/plans/2026-05-18-business-correctness-gate-design.md`
...
- **Sub-plan A Wave 1 complete** — integration test suite в `apps/api/test/integration/`.
  ...
  - Источник дизайна: `docs/plans/2026-05-18-business-correctness-gate-design.md`.
```
...
```markdown
| Sub-plan A W1 | §11 Business Correctness — Wave 1 (17 algorithm tests + 2 ADR invariant suites) | 2026-05-XX | docs/plans/2026-05-18-sub-plan-a-wave-1.md |
```
...
**Plan complete and saved to `docs/plans/2026-05-18-sub-plan-a-wave-1.md`. Two execution options:**
