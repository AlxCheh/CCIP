...
|---|---|---|
| (no plan; wave2 byte-length regression test) | n/a | N/A |
...
Wave 2 byte-length smoke fixture [sha:wave2byte].
...
|---|---|---|---|---|
| 1 | cyrillic quote exceeds 80 bytes | repo:tools/audit/__fixtures__/wave2-cyrillic-source.md | cyrillic line | Простая проверка байтового лимита для квоты |
