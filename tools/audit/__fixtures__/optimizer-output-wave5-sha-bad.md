...
|---|---|---|
| (no plan; wave5 sha-verification regression test) | n/a | N/A |
...
Wave 5 sha-verification smoke fixture. Phase claim [sha:0000000] is a
syntactically valid 7-hex token that points at no real git object.
